import { CATEGORIES, type DataOriginal } from '../../types/base';
import { makeDataUsable } from '../../utils/utils';

const mockApiDataRaw = {
  people: {
    name: 'Luke Skywalker',
    height: '172',
    mass: '77',
...
const dataNotUsable: DataOriginal[] = [
  { category: CATEGORIES.people, entries: [mockApiDataRaw.people] },
  { category: CATEGORIES.species, entries: [mockApiDataRaw.species] },
  { category: CATEGORIES.vehicles, entries: [mockApiDataRaw.vehicles] },
  { category: CATEGORIES.starships, entries: [mockApiDataRaw.starships] },
  { category: CATEGORIES.planets, entries: [mockApiDataRaw.planets] },
  { category: CATEGORIES.films, entries: [mockApiDataRaw.films] },
];

export const mockApiData = makeDataUsable(dataNotUsable);
